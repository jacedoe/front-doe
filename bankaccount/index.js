...
function operativa() {
	...
	let nom = document.getElementById("myInput1").value.toUpperCase();
	let cognom = document.getElementById("myInput2").value.toUpperCase();
...
function veureDetall(nom, cognom, num_comp) {
	let cuentaexist = false;
	nom = document.getElementById("myInput1").value.toUpperCase();
	cognom = document.getElementById("myInput2").value.toUpperCase();
	num_comp = parseInt(document.getElementById("myInput3").value);
	for (let i = 0; i < cuenta.length; i++) {
		if (num_comp == cuenta.getNumcomp && (nom + cognom) == cuenta.getTitular) {
			cuenta.veureCompte();
			cuentaexist = true;
...
function crearCompte() {
	let cuentaexist = false;
	let nom = prompt("Nombre").toUpperCase();
	let cognom = prompt("Apellidos").toUpperCase();
